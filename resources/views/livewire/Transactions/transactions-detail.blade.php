        ...
        <div
            ...
            <div class="flex items-center justify-between pb-5 mb-5 border-b border-gray-200 dark:border-neutral-700">
                ...
                <div class="inline-flex gap-x-2">
                    ...
                    <button type="button"
                        ...
                        onclick="window.open('{{ route('transactions.invoice.detail', $transaction->id) }}', '_blank')">
                        <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <div class="p-4 mt-6 space-y-4 border border-gray-200 rounded-lg dark:border-neutral-700">
                <div class="hidden sm:grid sm:grid-cols-5">
                    <div class="text-xs font-medium text-gray-500 uppercase sm:col-span-2 dark:text-neutral-500">Item
                    </div>
                    <div class="text-xs font-medium text-gray-500 uppercase text-start dark:text-neutral-500">Qty</div>
                    <div class="text-xs font-medium text-gray-500 uppercase text-start dark:text-neutral-500">Price
                    </div>
                ...
                @foreach ($items as $itemName => $item)
                    <div class="grid grid-cols-3 gap-2 sm:grid-cols-5">
                        ...
                        <div>
                            <h5 class="text-xs font-medium text-gray-500 uppercase sm:hidden dark:text-neutral-500">Qty
                            </h5>
                ...
                <div class="w-full max-w-2xl space-y-2 sm:text-end">
                    ...
                    <div class="grid grid-cols-2 gap-3 sm:grid-cols-1 sm:gap-2">
                        <dl class="grid text-sm sm:grid-cols-5 gap-x-3">
                            ...
                            <dd class="col-span-2 font-medium text-gray-800 dark:text-neutral-200">@currency($transaction->total)
                            </dd>
                        </dl>
                        ...
                        <dl class="grid text-sm sm:grid-cols-5 gap-x-3">
                            ...
                            <dd class="col-span-2 font-medium text-gray-800 dark:text-neutral-200">@currency($transaction->change)
                            </dd>
                        </dl>
                    </div>
                    <!-- End Grid -->
