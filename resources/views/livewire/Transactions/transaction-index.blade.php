    ...
    <div class="container">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-white rounded-md shadow-md h-[720px] overflow-auto  lg:col-span-1 md:col-span-2">
                    <div class="px-4 mt-6">
                        <div class="relative">
                    ...
                    <div class="bg-white rounded-md shadow-md 1 lg:col-span-1 md:col-span-2  h-[720px] overflow-auto ">
                                        ...
                                        <div class="relative">
                                            <div class="relative">
                                                ...
                                                <input class="search-btn" type="text"
                                                    placeholder="Choose a customer...." x-model="search"
                                                    @click="search === '' ? $wire.resetCustomer() : ''"
                                                    :class="{
